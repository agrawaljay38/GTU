...
<html>
    ...
    <body>
        ...
        <%
            ...
            ps=con.prepareStatement("update "+dept+"_vacancy set professor="+prof+" where coll_code='"+code+"'");
                ps.executeUpdate();
            if(assiprof>0)
            {
            ...
            ps=con.prepareStatement("update "+dept+"_vacancy set assistant_p="+assiprof+" where coll_code='"+code+"'");
            if(assoprof>0)
            {
            ...
            ps=con.prepareStatement("update "+dept+"_vacancy set associate_p="+assoprof+" where coll_code='"+code+"'");
            if(lect>0)
            {
            ...
            ps=con.prepareStatement("update "+dept+"_vacancy set lecturer="+lect+" where coll_code='"+code+"'");
        %>
